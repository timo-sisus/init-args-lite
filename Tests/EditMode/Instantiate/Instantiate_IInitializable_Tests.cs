...
{
	public class Instantiate_IInitializable_Tests
	{
		private AnyInitializable original;

		[SetUp]
		public void SetUp() => original = new GameObject(GetType().Name).AddComponent<AnyInitializable>();
