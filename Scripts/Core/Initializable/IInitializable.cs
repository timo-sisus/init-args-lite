...
namespace Sisus.Init
{
	...
	/// with an argument using the <see cref="AddComponentExtensions.AddComponent{TComponent}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TArgument> : IArgs<TArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// </summary>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TFirstArgument, TSecondArgument> : IArgs<TFirstArgument, TSecondArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TFirstArgument, TSecondArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// <para>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TFirstArgument, TSecondArgument, TThirdArgument> : IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TFirstArgument, TSecondArgument, TThirdArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// <para>
		/// It is also possible for the initialized object to retrieve the argument at any earlier stage of its initialization process,
		/// such as in the constructor or during the Awake event, using <see cref="InitArgs.TryGet{TFirstArgument, TSecondArgument, TThirdArgument}"/>.
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// <para>
		/// It is also possible for the initialized object to retrieve the argument at any earlier stage of its initialization process,
		/// such as in the constructor or during the Awake event, using <see cref="InitArgs.TryGet{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/>.
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument> : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// <para>
		/// It is also possible for the initialized object to retrieve the argument at any earlier stage of its initialization process,
		/// such as in the constructor or during the Awake event, using <see cref="InitArgs.TryGet{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/>.
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	public interface IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
	{
		...
		/// (after Awake and OnEnable but before Start) when an instance is created using the <see cref="InstantiateExtensions.Instantiate{TObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/> or the
		/// <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}">GameObject.AddComponent</see> function.
		/// </para>
		/// <para>
		/// It is also possible for the initialized object to retrieve the argument at any earlier stage of its initialization process,
		/// such as in the constructor or during the Awake event, using <see cref="InitArgs.TryGet{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/>.
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
	...
	/// <para>
	/// <see cref="MonoBehaviour"/>-derived classes that implement this interface can be added to a <see cref="GameObject"/>
	/// with arguments using the <see cref="AddComponentExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument}">GameObject.AddComponent</see> function.
	/// </para>
	/// <para>
